...
def standardizedNames(name):
    dizionario = {"sereno":["sereno", "sereno con lievi velature", "sereno o poco nuvoloso", "sereno con foschia",  "prevalentemente soleggiato", "soleggiato", "sereno notte", "Sunny", "Clear"],
                  ...
                  "pioggia": ["coperto con pioggia", "coperto con pioggia e nebbia", "coperto con rovesci di pioggia e nebbia", "pioggia moderata", "Moderate rain at times", "Moderate rain", "Moderate or heavy freezing rain", "Moderate or heavy rain shower", "nubi sparse e rovesci", "pioggia", "pioggia e schiarite", "rovesci di pioggia"],
...
def namesInValue(name):
    ...
    value = dizionario[name]
    if value is None:
        logging.warning(f"[namesInValue] Nessun valore numerico associato al nome '{name}'.")
    return value